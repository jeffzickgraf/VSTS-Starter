namespace VSTSDigitalDemoTests
{
	...
	{
		internal static readonly string APPNAME = "Starbucks";
		internal static readonly string NATIVEAPP = "NATIVE_APP";
		internal static readonly string WEBVIEW = "WEBVIEW";
		internal static readonly string VISUAL = "VISUAL";
		internal static readonly string IOS = "IOS";
